...
<div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
        <button type="button" class="button border-yellow" onclick="window.location.href='${pageContext.request.contextPath}/page/addProfessDevelop'">
    ...
    <table class="table table-hover text-center">
        ...
        <c:forEach items="${pageInfo.list}" var="professDevelop">
            <tr>
                <td>${professDevelop.id}</td>
