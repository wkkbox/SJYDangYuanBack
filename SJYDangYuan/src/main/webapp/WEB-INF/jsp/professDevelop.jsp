...
<div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
        ...
        <c:forEach items="${pageInfo.list}" var="professDevelop" varStatus="i">
            <tr>
                <td>${i.index+1}</td>
                <td align="center"><div style="width: 100px;padding-left: 0px" class='supercontent' onmouseover="overShow(this,event)" onmouseout="outHide()">${professDevelop.title}</div></td>
                <td align="center"><div style="width: 100px;padding-left: 0px" class='supercontent' onmouseover="overShow(this,event)" onmouseout="outHide()">${professDevelop.content}</div></td>
