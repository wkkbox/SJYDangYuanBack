...
<div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
        <button type="button" class="button border-yellow"
                onclick="window.location.href='${pageContext.request.contextPath}/page/addSheZe'">
    ...
    <table class="table table-hover text-center">
        ...
        <c:forEach items="${pageInfo.list}" var="sheZe" varStatus="i">
            <tr>
                <td>${i.index+1}</td>
                <td align="center"><div style="width: 100px;padding-left: 0px" class='supercontent' onmouseover="overShow(this,event)" onmouseout="outHide()">${sheZe.title}</div></td>
                <td align="center"><div style="width: 100px;padding-left: 0px" class='supercontent' onmouseover="overShow(this,event)" onmouseout="outHide()">${sheZe.content}</div></td>
                <td>
