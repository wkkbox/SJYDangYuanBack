...
<div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 本季报表</strong></div>
...
<script type="text/javascript">
    function fresh() {
        window.location.href = '${pageContext.request.contextPath}/page/seasonReport?currentPage=1&pageSize=6';
    }
</script>
<div class="pagelist">
    <c:if test="${pageInfo.pages!=0}">
        ...
        <c:if test="${pageInfo.pageNum!=1}">
            <a href="${pageContext.request.contextPath}/page/seasonReport?currentPage=${pageInfo.prePage}&pageSize=${pageInfo.pageSize}">上一页</a>
        </c:if>
