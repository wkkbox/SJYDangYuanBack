...
<div class="panel admin-panel margin-top">
    ...
    <div class="body-content">
        <form id="editHonorsAwardForm" method="post" class="form-x" action="${pageContext.request.contextPath}/honorsAward/editHonorsAward">
            <input type="hidden" value="${honorsAward.id}" name="id" />
