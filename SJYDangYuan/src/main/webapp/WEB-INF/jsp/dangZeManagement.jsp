...
<div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
        <button type="button" class="button border-yellow" onclick="window.location.href='${pageContext.request.contextPath}/page/addDangZe'"><span class="icon-plus-square-o"></span> 党责录入</button>
    </div>
    <table class="table table-hover text-center">
        ...
        <tr>
            ...
            <td>每季</td>
            <td>12分</td>
            <td><div class="button-group"> <a class="button border-main" href="xg.html"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="javascript:void(0)" onclick="return del(1,2)"><span class="icon-trash-o"></span> 删除</a> </div></td>
        </tr>
        <tr>
            <td>1</td>
            <td>标题</td>
