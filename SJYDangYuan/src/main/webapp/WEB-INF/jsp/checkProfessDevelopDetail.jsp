    ...
    <div class="body-content">
        ...
        <form method="post" class="form-x" action="">
            <div class="form-group">
                ...
                <div class="field">
                    <input readonly="readonly" type="text" class="input w50" name="professDevelopTitle" value="${professDevelopTitle}"/>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
                ...
                <div class="field">
                    <input readonly="readonly" type="text" class="input" name="professDevelopContent" value="${professDevelopContent}"/>
                </div>
            </div>
    ...
    function checkPass(userProfessDevelopId, userId, dScore, lScore, hScore,title,otherAttr) {
        ...
        $.ajax({
            ...
            success:function(data){
                alert(data.msg);
                window.location.href='${pageContext.request.contextPath}/page/checkProfessDevelop';
            },
            error:function(){
                alert("服务器异常");
            }
